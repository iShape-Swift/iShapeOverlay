    ...
    private let results: [Result] = [
        ...
        Result(
            ...
            regions: [[
                ...
                IntPath(unsafe: [
                    CGPoint(7.0, 20.0), CGPoint(5.0, -4.0004), CGPoint(5.0, 20.0)
                ].int),
                IntPath(unsafe: [
        ...
        Result(
            ...
            regions: [[
                ...
                IntPath(unsafe: [
                    CGPoint(10.0, -5.0), CGPoint(5.0, -5.0), CGPoint(5.0, 0.0), CGPoint(10.0, 0.0)
                ].int),
                IntPath(unsafe: [
                    CGPoint(-10.0, -10.0), CGPoint(-15.0, -10.0), CGPoint(-15.0, 15.0), CGPoint(-10.0, 15.0)
                ].int),
                IntPath(unsafe: [
                    CGPoint(0.0, 10.0), CGPoint(-5.0, 10.0), CGPoint(-5.0, 15.0), CGPoint(0.0, 15.0)
                ].int)
